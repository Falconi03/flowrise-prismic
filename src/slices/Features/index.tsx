...
const components: JSXMapSerializer = {
  ...
  heading3: ({ children }) => (
    <Heading as="h3" size="sm" className=" font-medium sm:text-left text-center mb-3">
      {children}
    </Heading>
  ),
  paragraph: ({ children }) => (
